      ...
      def install
        ...
        if defined?(::ActionView) && defined?(::ActionView::PartialRenderer)
          ...
          ::ActionView::PartialRenderer.class_eval do
            include ScoutApm::TracerPrepend

            instrument_method :render_partial,
              :type => "View",
              :name => ->(obj, args) { "#{obj.instance_variable_get("@template").virtual_path rescue "Unknown Partial"}/Rendering" },
              :scope => true

            instrument_method :collection_with_template,
              :type => "View",
              :name => ->(obj, args) { "#{obj.instance_variable_get("@template").virtual_path rescue "Unknown Collection"}/Rendering" },
              :scope => true
          end
          ...
          ::ActionView::TemplateRenderer.class_eval do
            ...
            instrument_method :render_template,
              :type => "View",
              :name => ->(obj, args) { "#{args[0].virtual_path rescue "Unknown"}/Rendering" },
              :scope => true
          end
        end
      end
