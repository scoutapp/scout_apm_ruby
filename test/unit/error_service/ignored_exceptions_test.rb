...
class IgnoredExceptionsTest < Minitest::Test
  ...
  def test_ignores_with_string_match
    ig = ScoutApm::ErrorService::IgnoredExceptions.new(["RuntimeError"])
  ...
  def test_ignores_subclasses
    ig = ScoutApm::ErrorService::IgnoredExceptions.new(["IgnoredExceptionsTest::FakeError"])
  ...
  def test_does_not_consider_unknown_errors
    ig = ScoutApm::ErrorService::IgnoredExceptions.new(["ThisDoesNotExist", "IgnoredExceptionsTest::FakeError"])
